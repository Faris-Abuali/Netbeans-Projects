...
public class QueueScroll extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlMainInside.add(lblHead, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 40, 30));
        ...
        pnlMainInside.add(lblTail, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 30, 30));

        lblInfo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblInfo.setText("Queue is Empty");
        pnlMainInside.add(lblInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 220, -1));
        ...
        pnlMainInside.add(pnlMenue, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 310, 140));
        ...
        pnlMainInside.add(cmboDataType, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 170, -1));
        ...
        pnlMainInside.add(lblInfo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 240, 230, -1));
        ...
        pnlMainInside.add(rdbtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, -1, -1));
        ...
        pnlMainInside.add(rdbtn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, -1, -1));
        ...
        pnlMainInside.add(rdbtn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 260, -1, -1));
        ...
        pnlMainInside.add(rdbtn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 290, -1, -1));
        ...
        pnlMainInside.add(rdbtn5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 290, -1, -1));

        lblInfo2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblInfo2.setText("Choose Data Type:");
        lblInfo2.setToolTipText("");
        pnlMainInside.add(lblInfo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 130, -1));
        ...
        pnlMainInside.add(btnMainMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 260, 70, 70));
    ...
    private void txtValueKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtValueKeyTyped
        ...
        if (cmboDataType.getSelectedIndex() == 0) {// integer
            ...
            if (!(Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE)
                ...
                getToolkit().beep();
                evt.consume();
                JOptionPane.showMessageDialog(pnlMainInside, "You are allowed to enter digit only!");
            ...
            if (value.length() > 0) {
                ...
                getToolkit().beep();
                evt.consume();
                JOptionPane.showMessageDialog(pnlMainInside, "You are allowed to enter Characters (1 Byte) only!");
            }
            ...
            if (c != '.' && !(Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE)
                ...
                getToolkit().beep();
                evt.consume();
                JOptionPane.showMessageDialog(pnlMainInside, "You are allowed to enter digits or decimal points only!");
            }
